...
if (isset($_POST['submit'])) {
    ...
    try{
        mysqli_query(
          ...
          echo "<script>alert('Data Berhasil Disimpan!'); window.location='list-jabatan.php';</script>";
    }catch(Exception $e){
...
<body class="bg-gradient-to-br from-indigo-100 to-purple-100 min-h-screen">
        ...
        <div class="container mx-auto px-4 py-4">
            <div class="flex flex-wrap items-center justify-center gap-2 md:gap-4 text-sm md:text-base">
                ...
                <?php if ($_SESSION['level'] == 'admin') : ?>
                    ...
                    <span class="text-gray-400">|</span>
                    <a href="list-jabatan.php" class="text-indigo-600 font-semibold border-b-2 border-indigo-600 pb-1">
    ...
    <div class="container mx-auto px-4 py-8">
        ...
        <div class="flex flex-col md:flex-row justify-between items-start md:items-center mb-8 gap-4">
            <div>
                <h1 class="text-3xl font-bold bg-gradient-to-r from-indigo-600 to-purple-600 bg-clip-text text-transparent mb-2">Tambah Jabatan Baru</h1>
                <p class="text-gray-600">Registrasi data jabatan baru</p>
            </div>
            <div class="flex gap-2">
                <a href="list-jabatan.php" 
            ...
            <div class="bg-gradient-to-r from-indigo-500 to-purple-600 p-6">
                <div class="flex items-center gap-4">
                    ...
                    <div class="text-white">
                        <h2 class="text-xl font-bold">Form Tambah Jabatan</h2>
                        <p class="text-indigo-100">Isi data jabatan baru</p>
                    </div>
                </div>
            </div>
                    ...
                    <div class="space-y-4">
                        <div>
                            <label class="block text-sm font-medium text-gray-700 mb-2">
                                <i class="fa-solid fa-briefcase text-indigo-500 mr-1"></i> Nama Jabatan
                            </label>
                            <input type="text" 
                                   name="nama_jabatan" 
                            ...
                            <div class="flex items-start gap-3">
                                ...
                                <div>
                                    ...
                                    <p class="text-blue-700 text-sm">
                                        Masukkan nama jabatan yang akan ditambahkan ke sistem. Pastikan nama jabatan unik dan sesuai dengan struktur organisasi.
                                    </p>
                                </div>
                            </div>
                        </div>
        ...
        <div class="mt-8 bg-white rounded-xl p-6 shadow-md border border-purple-100 max-w-2xl mx-auto">
            <div class="flex items-center justify-between">
                <div>
                    <h3 class="text-lg font-semibold text-gray-800 mb-1">Total Jabatan</h3>
                    <p class="text-gray-600 text-sm">Jumlah jabatan yang terdaftar</p>
                </div>
