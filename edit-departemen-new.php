...
$data_departemen = mysqli_fetch_assoc($query);

if (!$data_departemen) {
    echo "<script>alert('Data departemen tidak ditemukan!'); window.location='list-departemen-new.php';</script>";
    exit;
}
...
if (isset($_POST['submit'])) {
    ...
    try{
        mysqli_query(
          ...
          echo "<script>alert('Data Berhasil Diedit!'); window.location='list-departemen-new.php';</script>";
    }catch(Exception $e){
...
<head>
    ...
    <title>Edit Departemen - <?= htmlspecialchars($data_departemen['nama_departemen']) ?></title>
</head>
<body class="bg-gradient-to-br from-indigo-100 to-purple-100 min-h-screen">
    ...
    <div class="container mx-auto px-4 py-8">
        ...
        <div class="flex flex-col md:flex-row justify-between items-start md:items-center mb-8 gap-4">
            <div>
                <h1 class="text-3xl font-bold bg-gradient-to-r from-indigo-600 to-purple-600 bg-clip-text text-transparent mb-2">Edit Data Departemen</h1>
                <p class="text-gray-600">Perbarui informasi departemen</p>
            </div>
            <div class="flex gap-2">
                <a href="list-departemen-new.php" 
            ...
            <div class="bg-gradient-to-r from-indigo-500 to-purple-600 p-6">
                <div class="flex items-center gap-4">
                    ...
                    <div class="text-white">
                        <h2 class="text-xl font-bold">Edit Departemen: <?= htmlspecialchars($data_departemen['nama_departemen']) ?></h2>
                        <p class="text-indigo-100">ID Departemen: #<?= $id ?></p>
                    </div>
                </div>
            </div>
                ...
                <form action="" method="POST" class="space-y-6">
                    ...
                    <div class="bg-purple-50 border border-purple-200 rounded-lg p-4">
                        <div class="flex items-center gap-3">
                            ...
                            <div>
                                <h4 class="font-semibold text-purple-800">Data Saat Ini</h4>
                                <p class="text-purple-700 text-sm">Nama departemen: <strong><?= htmlspecialchars($data_departemen['nama_departemen']) ?></strong></p>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="space-y-4">
                        <div>
                            <label class="block text-sm font-medium text-gray-700 mb-2">
                                <i class="fa-solid fa-building text-indigo-500 mr-1"></i> Nama Departemen Baru
                            </label>
                            <input type="text" 
                                   name="nama_departemen" 
                                   value="<?= htmlspecialchars($data_departemen['nama_departemen']) ?>"
                            ...
                            <div class="flex items-start gap-3">
                                ...
                                <div>
                                    ...
                                    <p class="text-amber-700 text-sm">
                                        Perubahan nama departemen akan mempengaruhi data pegawai yang terkait. Pastikan perubahan sudah benar sebelum menyimpan.
                                    </p>
                                </div>
                            </div>
                        </div>
        ...
        <div class="mt-8 bg-white rounded-xl p-6 shadow-md border border-purple-100 max-w-2xl mx-auto">
            <div class="flex items-center justify-between">
                <div>
                    ...
                    <p class="text-gray-600 text-sm">Departemen ini digunakan oleh data pegawai</p>
                </div>
                <div class="bg-purple-100 p-3 rounded-lg">
                    <i class="fa-solid fa-link text-purple-600 text-xl"></i>
                </div>
            </div>
        </div>
    </div>
