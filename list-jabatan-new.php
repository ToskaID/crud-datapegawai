...
<body class="bg-gradient-to-br from-indigo-100 to-purple-100 min-h-screen">
    ...
    <div class="container mx-auto px-4 py-8">
        ...
        <div class="flex flex-col md:flex-row justify-between items-start md:items-center mb-8 gap-4">
            <div>
                <h1 class="text-3xl font-bold bg-gradient-to-r from-indigo-600 to-purple-600 bg-clip-text text-transparent mb-2">Data Jabatan</h1>
                <p class="text-gray-600">Manajemen Data Jabatan Toska Corp.</p>
                <div class="mt-4">
                    <a href="jabatan-new.php" class="inline-block px-4 py-2 bg-amber-500 text-amber-950 font-semibold rounded-xl hover:bg-amber-600 transition-all duration-300 shadow-xl">
            ...
            <div class="bg-white rounded-xl p-4 shadow-md border border-purple-100">
                <div class="flex items-center justify-between">
                    <div>
                        ...
                        <p class="text-2xl font-bold text-indigo-600"><?= count($jabatan) ?></p>
                    </div>
            ...
            <div class="bg-white rounded-xl p-4 shadow-md border border-purple-100">
                <div class="flex items-center justify-between">
                    <div>
                        ...
                        <p class="text-2xl font-bold text-green-600"><?= count($jabatan) ?></p>
                    </div>
                ...
                <div class="flex items-center justify-between">
                    <div>
                        ...
                        <p class="text-2xl font-bold text-blue-600">
                            <?php 
                            $latest = end($jabatan);
                            echo substr($latest['nama_jabatan'] ?? '', 0, 10) . '...';
                            ?>
                        </p>
                    </div>
            ...
            <div class="bg-gradient-to-r from-indigo-500 to-purple-600 p-4">
                <div class="flex items-center justify-between text-white">
                    <h2 class="text-lg font-semibold">
                        <i class="fa-solid fa-list mr-2"></i>Daftar Jabatan
                    </h2>
                    <div class="text-sm">
                        Total: <?= count($jabatan) ?> data
                    </div>
                </div>
            </div>
                ...
                <table class="w-full table-auto">
                    <thead>
                        <tr class="bg-gray-50 border-b border-gray-200">
                            ...
                            <th class="px-6 py-4 text-left font-semibold text-gray-700">Nama Jabatan</th>
                                ...
                                <tr class="border-b border-gray-100 hover:bg-indigo-50 transition-colors duration-200">
                                    ...
                                    <td class="px-6 py-4">
                                        <div class="flex items-center gap-3">
                                            <div class="w-10 h-10 bg-gradient-to-br from-indigo-400 to-indigo-600 rounded-lg flex items-center justify-center text-white font-semibold">
                                                <?= strtoupper(substr($j['nama_jabatan'], 0, 1)) ?>
                                            </div>
                                            <div>
                                                <div class="font-medium text-gray-800"><?= htmlspecialchars($j['nama_jabatan']) ?></div>
                                    ...
                                    <td class="px-6 py-4">
                                        <div class="flex justify-center gap-2">
                                            <a href="edit-jabatan-new.php?id=<?= $j['id'] ?>" 
                                            ...
                                            <a href="delete-jabatan.php?id=<?= $j['id'] ?>" 
                                               onclick="return confirm('Apakah Anda yakin ingin menghapus jabatan <?= htmlspecialchars($j['nama_jabatan']) ?>?')"
        ...
        <div class="mt-8 text-center text-gray-500 text-sm">
            <p>Total <?= count($jabatan) ?> data jabatan</p>
        </div>
    </div>
</body>
</html>
